...
var HttpResourceImpl = class extends ResourceImpl {
  ...
  constructor(injector, request, defaultValue, map2) {
    super(request, ({
      request: request2,
      abortSignal
    }) => {
        ...
        next: (event) => {
          switch (event.type) {
            case HttpEventType.Response:
              ...
              try {
                send({
                  value: map2 ? map2(event.body) : event.body
                });
              } catch (error) {
                send({
                  error
...
@angular/common/fesm2022/http.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-EOHYAFQS.js.map
